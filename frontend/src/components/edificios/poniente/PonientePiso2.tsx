    ...
    <div>
        ...
        >	 
            ...
            <style>{`
                ...
                .t3 { font-size: 30px;fill: #ffffff;font-weight: 400;font-family: "DejaVuSans", "DejaVu Sans" } 
                .t4 { font-size: 26px;fill: #ffffff;font-weight: 400;font-family: "DejaVuSans", "DejaVu Sans" } 
            `}</style>
            ...
            <text id="PRINTER" style={{...textStyle, transform: "matrix(0,-1.276,1.276,0,1402.321,419.547)"}} >
            ...
            <text id="Escalera" style={{...textStyle, transform: "matrix(1.276,0,0,1.276,1087.259,422.098)"}} >
                <tspan x="-50" y="-5" className="t3">Escalera
        </tspan>
            </text>
